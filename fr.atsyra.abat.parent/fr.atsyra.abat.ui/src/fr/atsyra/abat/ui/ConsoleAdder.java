...
public class ConsoleAdder extends Handler {
	...
	public static void startConsole() {
		if (listener == null) {
			...
			listener = new ConsoleAdder("fr.atsyra.abat");
			Logger.getLogger("fr.atsyra.abat").addHandler(listener);
		}
	}

	public static void stopconsole() {
		if (listener != null) {
			Logger.getLogger("fr.atsyra.abat").removeHandler(listener);
			listener = null;
		}
	}
		...
		Display.getDefault().asyncExec(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					Logger.getLogger("fr.atsyra.abat").info("Could not force display of console view (probably eclipse is busy ?).");					
				}				
			}
